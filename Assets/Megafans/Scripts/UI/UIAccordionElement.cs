...
namespace UnityEngine.UI
{
	...
	public class UIAccordionElement : Toggle {
		...
		public void OnValueChanged(bool state)
		{
            ...
            bool allowSwitchOff = true;  // this.group.allowSwitchOff;
            ExpandableTextItem viewHandler = this.gameObject.GetComponent<ExpandableTextItem>();
            ...
            viewHandler.toggleOnButton(isSelected);
            //if (state)
            //{
