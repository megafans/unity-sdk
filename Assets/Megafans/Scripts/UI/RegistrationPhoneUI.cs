...
namespace MegafansSDK.UI
{
    ...
    {
        IDictionary<string, string> countryCodesMapping = new Dictionary<string, string>() {
   { "Afghanistan", "93" },
   { "Åland Islands", "358" },
   { "Albania", "355" },
   { "Algeria", "213" },
   ...
   { "Zimbabwe", "263" },
        ...
        [SerializeField] private Text countryCodeText;

        private void Awake()
        {
            StartCoroutine(checkCountryCode());
        }

        IEnumerator checkCountryCode()
        {
            ...
            using (UnityWebRequest webRequest = UnityWebRequest.Get(uri))
            {
                ...
                countryCodeText.text = "+" + countryCodesMapping[ipApiData.country_name];
            }
        }
        ...
        public void ContinueBtn_OnClick()
        {
            ...
            combinedCountryCodeAndPhoneNumber = countryCodeText.text + phoneNumberField.text;
